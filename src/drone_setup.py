...
class DroneSetup:
    ...
    def schedule_mission(self):
        ...
        if self.drone_config.mission in [1, 2]:
            if self.drone_config.state == 1 and current_time >= self.drone_config.trigger_time:
                ...
                if self.drone_config.mission == 1:
                    ...
                    message = self.run_mission_script("python3 /home/ander/Desktop/SARdrones/src/offboard_multiple_from_csv.py")
                    ...
                    if int(self.drone_config.swarm.get('follow')) != 0:
                        ...
                        # asyncio.run(self.offboard_controller.init_leader_checks())
                        message = "Assumed success for Swarm Mission."
        ...
        # If the mission is to take off to a certain altitude
            ...
            success, message = self.run_mission_script(f"python /home/ander/Desktop/SARdrones/src/actions.py --action=takeoff --altitude={altitude}")
        ...
        # If the mission is to hold the position
            ...
            success, message = self.run_mission_script("python3 /home/ander/Desktop/SARdrones/src/actions.py --action=hold")
        
        # If the mission is a test
        elif self.drone_config.mission == 100:
            logging.info("Starting Test")
            success, message = self.run_mission_script("python3 /home/ander/Desktop/SARdrones/src/actions.py --action=test")
